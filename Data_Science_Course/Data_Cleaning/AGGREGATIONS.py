...
"""" A way of defining a data frame through dictionary , when the dictionary is not defined """
...
dt = pd.DataFrame(dict(Id=np.arange(1437), A=np.arange(1437)), index= np.arange(1437))
print(dt)